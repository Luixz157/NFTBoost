...
//OBS: ao criar IMAGE tem a propria image do NEXT.JS
export function CardNFT({thumbnail, name, value, value_brl}) {
    return (
        <div className="w-full max-w-cardnft overflow-hidden rounded-2xl border border-green-border-card bg-gray-area-favorite">
